    ...
    with socket.socket(socket.AF_INET, socket.SOCK_DGRAM) as udp_socket:
        ...
        while packet_next < file_len or packet_in_flight:
            ...
            # TIMEOUT
                ...
                print("TIMEOUT pre, cwnd: ", cwnd, " ssthresh: ", ssthresh)
                ...
                print("TIMEOUT post, cwnd: ", cwnd, " ssthresh: ", ssthresh)
        
        transfer_end_time = time.time()    
        print("Transfer Time: ", transfer_end_time - transfer_start_time)
        print("Avg Per-Packet Delay", sum(delays)/len(delays))
